...
class BGSprite extends FlxSprite
{
	...
	public function new(image:String, library:String, ?locale:Bool, x:Float = 0, y:Float = 0, ?scrollX:Float = 1, ?scrollY:Float = 1,
			?anim:Array<String> = null, ?loop:Bool = false, ?framerate:Int = 24)	{
		super(x, y);
