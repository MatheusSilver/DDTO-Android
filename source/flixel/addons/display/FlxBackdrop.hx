...
//Basicamente um dos devs do mod fez uma mudança aqui pra aceitar shaders (sem elas o menu fica deveras sus)
//Entretanto, um outro maluco fez outra mudança que deixou o backdrop totalmente incompativel com o flixel 7.9.0
//Consequentemente, apenas coloquei isso aqui pra poder utilizar a exata versão com as modificações que precisavamos sem ter que att o flixel pra uma versão incopatível.
