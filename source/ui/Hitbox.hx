...
class Hitbox extends FlxSpriteGroup
{
	...
	public function new(?widghtScreen:Int)
	{
		...
		var hitbox_hint:FlxSprite = new FlxSprite(0, 0).loadGraphic('assets/shared/images/hitbox/hitbox_hint_old.png');
	...
	public function createhitbox(X:Float, framestring:String)
	{
		...
		var frames = FlxAtlasFrames.fromSparrow('assets/shared/images/hitbox/hitbox_hint.png', 'assets/shared/images/hitbox/hitbox.xml');
